...
MVP Candidates and Run Value For Each Zone
...
This graph below shows the 2019 NL and AL MVP candidates (excluding pitchers) and their run value for each zone.
```{r}
#| warning: false
#| echo: false
#| message: false
...
```
#Top Hitters In Chase and Waste
```{r, include= FALSE, echo= FALSE}
#| warning: false
#| results: hide
#| message: false
